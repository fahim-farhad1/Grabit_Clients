      ...
      <div className="flex gap-2">
        {user ? (
          <button
            ...
            className="flex gap-1 items-center w-[144px]"
          >
        ...
        <button className="flex items-center gap-1">
          ...
          <div>
            <p className="font-bold text-[12px] bg-red-500 text-white px-[7px] py-[2px] rounded-full absolute top-[10px] right-[120px]">
              3
            </p>
          </div>
        </button>
        <button className="flex items-center gap-1 relative">
          ...
          <div>
            <p className="font-bold text-[12px] bg-red-500 text-white px-[7px] py-[2px] rounded-full absolute -top-[10px] -right-[12px]">
              3
            </p>
          </div>
        </button>
