...
const ProductsCard = ({ img, name, weight, price, stock, id, category }) => {
      ...
      <div className="w-[220px] h-[370px] text-center border rounded">
        ...
        <button
          className={`${
            stock == 0
              ? "disable"
              : "px-10 mb-1 mt-3 rounded py-2 hover:px-12 hover:py-3 active:bg-[#4c9279] duration-100 bg-primary text-white"
          }`}
        >
          Add to Cart
        </button>
